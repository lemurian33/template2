...
const subscribeContent = {
  heading : {
    ...
    description :"Join our community of subscribers today and stay connected with all the exciting developements!",
  },
  form : {
        ...
        <div className="flex flex-col mx-auto justify-center">
          <motion.form
            ...
            <input
              ...
              required type='email'
            />
            <button type='submit' className='apperance-none absolute top-1 right-1
          ...
          <motion.p
            ...
            className="w-auto max-w-md mx-auto mt-10 text-center text-white
              text-opacity-60 ">{subscribeContent.heading.description}
          </motion.p>
        </div>
