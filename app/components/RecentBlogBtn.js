...
import {Swipper, SwipperSlide } from 'swiper/swiper-react'
import 'swiper/css'
...
const recentBlogContent2 = {
  heading: {
    title: "Our latest articles",
    subTitle: "Our writeups",
    description:"Nous nous spécialisons dans la création d'application destinées à optimiser le porcess quotidien de nos clients."  },
};
    ...
    <section className={`${className}`}>
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3
          xl:grid-cols-4 gap-5 w-full lg:w-10/12 mx-auto mt-10 ">
